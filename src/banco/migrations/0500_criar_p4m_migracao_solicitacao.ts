...
export async function up(knex: Knex): Promise<void> {
  return knex.schema
    .createTable(ETableNames.p4m_migracao_solicitacao, (table) => {
      ...
      // CONSULTADO_PLANILHA -> quando ainda está na fila para ser baixado a planilha
      ...
      table.enu('status', ['CONSULTADO_PLANILHA', 'EDITANDO', 'PROCESSANDO', 'FINALIZADO', 'CANCELADO', 'ERRO']).notNullable();
